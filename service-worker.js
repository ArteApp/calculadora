...
self.toolbox.options.cache = {
  name: 'calculadoradamorte-cache-201803141951'
};
...
self.addEventListener('push', function (event) {
  ...
  const title = 'Calculadora da Morte';
  const options = {
...
const db = new PouchDB('calculadoradamorte');
const remotedb = new PouchDB('https://admin:8eda208157d4@couchdb-bfef4c.smileupps.com/calculadoradamorte');
